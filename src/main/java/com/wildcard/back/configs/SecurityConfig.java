...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().configurationSource(corsConfigurationSource())
                ...
                .antMatchers(HttpMethod.DELETE, "/word/{id}/delete").hasRole("ADMIN")
                .antMatchers(HttpMethod.POST, "/lib/{idLib}/add").hasRole("ADMIN")
                .antMatchers(HttpMethod.POST, "/lib/{idLib}/{idWord}/add").hasRole("ADMIN")
                .antMatchers(HttpMethod.POST, "/lib/add").hasRole("ADMIN")
                .antMatchers(HttpMethod.DELETE, "/lib/{id}/delete").hasRole("ADMIN")
                .antMatchers(HttpMethod.PATCH, "/lib/{id}/update").hasRole("ADMIN")
